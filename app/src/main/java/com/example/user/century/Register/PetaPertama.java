...
public class PetaPertama extends FragmentActivity implements OnMapReadyCallback,
...
//    SessionRegister session2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_pertama);
        ...
        session = new SessionManagement(getApplicationContext());
//        session2 = new SessionRegister(getApplicationContext());
//        HashMap<String, String> user = session2.getUserDetails();
//        final String nama = user.get(SessionRegister.KEY_NAMA);
//        final String alamat = user.get(SessionRegister.KEY_ALAMAT);
//        final String tanggal = user.get(SessionRegister.KEY_TANGGAL);
//        final String gender = user.get(SessionRegister.KEY_GENDER);
//        final String email = user.get(SessionRegister.KEY_EMAIL2);
//        final String password = user.get(SessionRegister.KEY_PASSWORD2);
//        final String phone = user.get(SessionRegister.KEY_PHONE);
//        final String member = user.get(SessionRegister.KEY_ANGGOTA);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //////////////////////////////////////////////////////////
                /////////update lokasi pertama
                JSONObject objRegister = new JSONObject();
                try {
                    JSONArray arrData = new JSONArray();
                    JSONObject objDetail = new JSONObject();
                    objDetail.put("email",user.get(SessionManagement.KEY_EMAIL));
                    objDetail.put("id_lokasi",panduanId);
                    arrData.put(objDetail);
                    objRegister.put("data",arrData);
                } catch (JSONException e1) {
                    e1.printStackTrace();
                }
                JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST, UBAH_LOKASI_URL, objRegister,
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    if(response.getString("status").equals("OK")) {
                                        ...
                                        Intent i = new Intent(PetaPertama.this, MainActivity.class);
                                        startActivity(i);
                                    }
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(PetaPertama.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker mark) {
                Animation anim = AnimationUtils.loadAnimation(PetaPertama.this, R.anim.translate);
        ...
        /*
        LatLng mark= new LatLng(tempLatitude,tempLongitude);
        draw(mark);
        mMap.addMarker(new MarkerOptions().position(mark).title(btnLokasi.getText().toString()));
    ...
    public void onLocationChanged(Location location) {
        ...
        btnLokasi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PetaPertama.this,PilihPetaPertama.class);
...
//        LoginManager.getInstance().logOut();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(PetaPertama.this,RegisterActivity.class);
        startActivity(i);
    }
...
/*
 session = new SessionManagement(getApplicationContext());
                ...
                JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST, LOKASI_URL, objAktivitas,
                        new Response.Listener<JSONObject>() {
                            @Override
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    if(response.getString("status").equals("OK")) {
                                        Toast.makeText(PetaPertama.this, "Berhasil Menambahkan Peta", Toast.LENGTH_SHORT).show();
                                    }
                                    else if(response.getString("status").equals("FALSE")){
                        ...
                        new Response.ErrorListener() {
                            @Override
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(PetaPertama.this,"Terjadi Kendala Koneksi",Toast.LENGTH_LONG ).show();
                            }
                        }) ;
                RequestQueue requestQueue = Volley.newRequestQueue(PetaPertama.this);
                requestQueue.add(stringRequest);
                ...
                Intent z = new Intent(PetaPertama.this,MainActivity.class);
                //z.putExtra("panduanId",panduanId);
                startActivity(z);
 */
