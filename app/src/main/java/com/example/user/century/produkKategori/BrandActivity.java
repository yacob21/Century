    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            for (int i = 0; i < users.length(); i++) {
                                ...
                                String url1 = "http://fransis.rawatwajah.com/century/getBrand.php?nama_kategori="+kategori.get(SessionKategori.KEY_KATEGORI).replace(" ","+")
                                        +"&id_lokasi="+id_lokasi;
        ...
        etSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                ba = new brandAdapter(BrandActivity.this, resultSearch);
                cardListBrand.setAdapter(ba);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(BrandActivity.this,FilterActivity.class);
        ...
        btnRefresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isDataConnectionAvailable(BrandActivity.this) == false){
                    Toast.makeText(BrandActivity.this, "Tidak Ada Koneksi Internet", Toast.LENGTH_SHORT).show();
