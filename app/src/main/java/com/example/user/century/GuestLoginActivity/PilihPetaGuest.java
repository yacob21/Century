...
public class PilihPetaGuest extends AppCompatActivity {
    List<LokasiPertama> result = new ArrayList<>();
    List<LokasiPertama> resultSearch = new ArrayList<>();
    PilihPetaGuestAdapter pppa;
    RecyclerView cardListPetaGuest;
    Context context;
    String nama,alamat;
    double jarak;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pilih_peta_guest);
        ...
        cardListPetaGuest = (RecyclerView) findViewById(R.id.cardListPetaGuest);
        cardListPetaGuest.setHasFixedSize(true);
        LinearLayoutManager llm = new LinearLayoutManager(this);
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        cardListPetaGuest.setLayoutManager(llm);
        context = this;
        ...
        JsonObjectRequest req = new JsonObjectRequest(url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        for (int i = 0; i < users.length(); i++) {
                            ...
                            pppa = new PilihPetaGuestAdapter(context,result);
                            cardListPetaGuest.setAdapter(pppa);
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PilihPetaGuest.this,"Terjadi Kendala Koneksi",Toast.LENGTH_LONG ).show();
            }
        });
        queue.add(req);
        ...
        etSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                pppa = new PilihPetaGuestAdapter(PilihPetaGuest.this, resultSearch);
                cardListPetaGuest.setAdapter(pppa);
                cardListPetaGuest.setLayoutManager(new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.VERTICAL, false));
            }
        });
        ...
        btnRefresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isDataConnectionAvailable(PilihPetaGuest.this) == false){
                    Toast.makeText(PilihPetaGuest.this, "Tidak Ada Koneksi Internet", Toast.LENGTH_SHORT).show();
