...
public class Rekomendasi {
    ...
    public Rekomendasi(String nama, int harga, String merk, String id_kategori,String id_promosi,String subkategori,String gambar,String id_produk,String stok,String diskon,String id_Produk_Per_Lokasi){
        this.Nama = nama;
        this.Harga=harga;
        this.Merk=merk;
        this.Gambar=gambar;
    ...
    public Rekomendasi(String nama, String merk, String id_kategori, String subkategori, String gambar, String id_produk){
        this.Nama = nama;
        this.Merk=merk;
        this.Gambar=gambar;
        this.Subkategori=subkategori;
